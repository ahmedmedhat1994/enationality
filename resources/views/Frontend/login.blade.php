                        ...
                        <div class="col-lg-4">
                            <div class="card card-bordered h-100" id="mobileNumer">
                                <div class="card-inner">
                                    <div class="card-head">
                                        <h5 class="card-title">الدخول / تسجيل حساب</h5>
                                    </div>
                                    <form id="loginForm" action="{{route('otp')}}" method="post" autocomplete="off">
                                        @csrf
                                        <div class="form-group">
                                            <label class="form-label" for="mobile">رقم الموبايل
                                            <br>
                                                <span class="text-danger">يرج كتابة رقم الموبايل المكون من 11 رقم مثل 010xxxxxxxx</span>
                                            </label>
                                            <div class="form-control-wrap">
                                                <input type="number" class="form-control fs-3" id="mobile" name="mobile" value="{{old('mobile')}}" placeholder="010xxxxxxxx">
                                            </div>
                                        </div>
                                        @if ($errors->any())
