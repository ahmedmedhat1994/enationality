            ...
            <div class="nk-content-body">
                ...
                <div class="nk-block pt-5">
                    <div class="row g-gs d-flex justify-content-center justify-items-center">
                        <div class="modalIS">
                            <form class="form" method="post" action="{{route('payGo')}}">
                                @csrf
                            ...
                            id="XMLID_34_"></path>
                                ...
                                <div class="card-info">
                                    <div class="input_container">
                                        ...
                                        <input class="input_field" type="text" value="sherif ibrahem qandel" placeholder="Enter your full name">
                                        <input class="input_field" type="hidden" value="{{$code}}" name="code" placeholder="">
                                    </div>
                                    <div class="input_container">
                                        <label class="input_label">Card Number</label>
                                        <input class="input_field" type="number" value="5757 5757 5757 5757" placeholder="0000 0000 0000 0000">
                                    </div>
                                    <div class="input_container">
                                        <label class="input_label">Expiry Date / CVV</label>
                                        <div class="split">
                                            <input class="input_field" style="width:  250px;" type="text" value="01/23" placeholder="01/23">
                                            <input class="input_field" style="width: 110px;" type="number" placeholder="CVV" value="565">
                                        </div>
                                    </div>
                                </div>
